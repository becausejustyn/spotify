...
### Valence
```{r}
hchart(df$val, type = "column")
```   

### Duration 
```{r}
hchart(df$dur, type = "column")
```

### Danceability                      
```{r}
hchart(df$dnce, type = "column")
```

### Energy                      
```{r}
hchart(df$nrgy, type = "column")
```                      
          
### Acousticness                      
```{r}
hchart(df$acous, type = "column")
```    

### Loudness                      
```{r}
hchart(df$dB, type = "column")
```   

### Speechiness                      
```{r}
hchart(df$spch, type = "column")
```  

### Liveness
```{r}
hchart(df$live, type = "column")    
```   

### Beats Per Min
```{r}
hchart(df$bpm, type = "column")
```
